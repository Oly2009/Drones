...
$sql = "SELECT
            ...
            tr.fecha_ejecucion AS fecha, tr.hora, tr.estado_general
        FROM drones d
...
if (!$consulta) {
    echo "<div class='alert alert-danger text-center'>Error al ejecutar la consulta: " . mysqli_error($conexion) . "</div>";
}
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-YEVcwkGImcM4N0b9WYgK5QVhqgIrPQhqenKF0fIljRylqqcnF6GMYV6W3utcNlYl" crossorigin="anonymous">
</head>
...
<main class="container flex-grow-1 py-5">
    <section>
        ...
        <?php else: ?>
            <div class="alert alert-danger text-center">⚠️ Hubo un error al cargar los drones.</div>
        <?php endif; ?>
